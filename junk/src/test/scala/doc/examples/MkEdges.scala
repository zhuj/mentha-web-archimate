...
object MkEdges extends MkModel {
  ...
  def main(args: Array[String]): Unit = {
    ...
    in(view) connection ( o1r, in(view) notes "Composition Relationship" scaleWidth(2) place(directions.Right, o1r) )
    ...
    in(view) connection ( o2r, in(view) notes "Aggregation Relationship" scaleWidth(2) place(directions.Right, o2r) )
    ...
    in(view) connection ( o3r, in(view) notes "Assignment Relationship" scaleWidth(2) place(directions.Right, o3r) )
    ...
    in(view) connection ( o4r, in(view) notes "Realization Relationship" scaleWidth(2) place(directions.Right, o4r) )
    ...
    in(view) connection ( o5r, in(view) notes "Serving Relationship" scaleWidth(2) place(directions.Right, o5r) )
    ...
    in(view) connection ( o6r, in(view) notes "Access Relationship" scaleWidth(2) place(directions.Right, o6r) )
    ...
    in(view) connection ( o7r, in(view) notes "Influence Relationship" scaleWidth(2) place(directions.Right, o7r) )
    ...
    in(view) connection ( o8r, in(view) notes "Triggering Relationship" scaleWidth(2) place(directions.Right, o8r) )
    ...
    in(view) connection ( o9r, in(view) notes "Flow Relationship" scaleWidth(2) place(directions.Right, o9r) )
    ...
    in(view) connection ( oAr, in(view) notes "Specialization Relationship" scaleWidth(2) place(directions.Right, oAr) )
    ...
    in(view) connection ( oBr, in(view) notes "Association Relationship" scaleWidth(2) place(directions.Right, oBr) )
