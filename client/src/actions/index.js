...
export const VIEW_SELECT_OBJECTS = /*Symbol*/("VIEW_SELECT_OBJECTS")
export const selectViewObjects = (viewId, selection) => ({
  type: VIEW_SELECT_OBJECTS,
  viewId: viewId,
  selection: _.map(selection, (o) => o.id)
});