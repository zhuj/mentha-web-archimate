...
object Composition {
  ...
  implicit class ImplicitGrouping(src: Grouping) {
    ...
    def `accesses`($0: AccessType) = new {
      def `of`(dst: Artifact)(implicit model: Model): AccessRelationship = _accesses_of(src, dst)($0)(model)
      def `of`(dst: BusinessObject)(implicit model: Model): AccessRelationship = _accesses_of(src, dst)($0)(model)
      def `of`(dst: Contract)(implicit model: Model): AccessRelationship = _accesses_of(src, dst)($0)(model)
      ...
      def `of`(dst: Material)(implicit model: Model): AccessRelationship = _accesses_of(src, dst)($0)(model)
      def `of`(dst: Plateau)(implicit model: Model): AccessRelationship = _accesses_of(src, dst)($0)(model)
      def `of`(dst: Representation)(implicit model: Model): AccessRelationship = _accesses_of(src, dst)($0)(model)
    }
  ...
  implicit class ImplicitLocation(src: Location) {
    ...
    def `assigned-to`(dst: Grouping)(implicit model: Model): AssignmentRelationship = _assigned_to(src, dst)(model)
    @derived def `assigned-to`(dst: ApplicationEvent)(implicit model: Model): AssignmentRelationship = _assigned_to(src, dst)(model)
    @derived def `assigned-to`(dst: ApplicationFunction)(implicit model: Model): AssignmentRelationship = _assigned_to(src, dst)(model)
    @derived def `assigned-to`(dst: ApplicationInteraction)(implicit model: Model): AssignmentRelationship = _assigned_to(src, dst)(model)
    @derived def `assigned-to`(dst: ApplicationProcess)(implicit model: Model): AssignmentRelationship = _assigned_to(src, dst)(model)
    ...
    def `influences`($0: String) = new {
      ...
      @derived def `in`(dst: Stakeholder)(implicit model: Model): InfluenceRelationship = _influences_in(src, dst)($0)(model)
