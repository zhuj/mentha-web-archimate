...
object Composition {
  ...
  implicit class ImplicitGrouping(src: Grouping)(implicit val model: Model) {
    ...
    def `serves`(dst: Plateau): ServingRelationship = _serves(src, dst)(model)
    ...
    def `accesses`($0: AccessType) = new {
      ...
      def `of`(dst: Plateau): AccessRelationship = _accesses_of(src, dst)($0)(model)
    ...
    def `flows`($0: String) = new {
      ...
      def `to`(dst: Plateau): FlowRelationship = _flows_to(src, dst)($0)(model)
    ...
    def `assigned-to`(dst: Plateau): AssignmentRelationship = _assigned_to(src, dst)(model)
    ...
    def `reads`(dst: Plateau): AccessRelationship = _reads(src, dst)(model)
    ...
    def `writes`(dst: Plateau): AccessRelationship = _writes(src, dst)(model)
  ...
  implicit class ImplicitLocation(src: Location)(implicit val model: Model) {
    ...
    def `assigned-to`(dst: Junction): AssignmentRelationship = _assigned_to(src, dst)(model)
    def `assigned-to`(dst: Grouping): AssignmentRelationship = _assigned_to(src, dst)(model)
    @derived def `assigned-to`(dst: ApplicationEvent): AssignmentRelationship = _assigned_to(src, dst)(model)
    @derived def `assigned-to`(dst: ApplicationFunction): AssignmentRelationship = _assigned_to(src, dst)(model)
    @derived def `assigned-to`(dst: ApplicationInteraction): AssignmentRelationship = _assigned_to(src, dst)(model)
    @derived def `assigned-to`(dst: ApplicationProcess): AssignmentRelationship = _assigned_to(src, dst)(model)
    @derived def `assigned-to`(dst: ApplicationService): AssignmentRelationship = _assigned_to(src, dst)(model)
    ...
    def `influences`($0: String) = new {
      ...
      @derived def `in`(dst: Stakeholder): InfluenceRelationship = _influences_in(src, dst)($0)(model)
