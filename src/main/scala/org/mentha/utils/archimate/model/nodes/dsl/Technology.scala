...
object Technology {
  ...
  implicit class ImplicitCommunicationNetwork(src: CommunicationNetwork) {
    ...
    def `aggregates`(dst: Grouping)(implicit model: Model): AggregationRelationship = _aggregates(src, dst)(model)
    def `aggregates`(dst: SystemSoftware)(implicit model: Model): AggregationRelationship = _aggregates(src, dst)(model)
    @derived def `aggregates`(dst: Equipment)(implicit model: Model): AggregationRelationship = _aggregates(src, dst)(model)
    @derived def `aggregates`(dst: Facility)(implicit model: Model): AggregationRelationship = _aggregates(src, dst)(model)
