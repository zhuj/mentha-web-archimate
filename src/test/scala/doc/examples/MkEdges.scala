...
object MkEdges extends MkModel {
  ...
  def main(args: Array[String]): Unit = {
    ...
    in(view) connect ( o1r, in(view) notes "Composition Relationship" doubleWidth() place(directions.Right, o1r) )
    ...
    in(view) connect ( o2r, in(view) notes "Aggregation Relationship" doubleWidth() place(directions.Right, o2r) )
    ...
    in(view) connect ( o3r, in(view) notes "Assignment Relationship" doubleWidth() place(directions.Right, o3r) )
    ...
    in(view) connect ( o4r, in(view) notes "Realization Relationship" doubleWidth() place(directions.Right, o4r) )
    ...
    in(view) connect ( o5r, in(view) notes "Serving Relationship" doubleWidth() place(directions.Right, o5r) )
    ...
    in(view) connect ( o7r, in(view) notes "Influence Relationship" doubleWidth() place(directions.Right, o7r) )
    ...
    in(view) connect ( o8r, in(view) notes "Triggering Relationship" doubleWidth() place(directions.Right, o8r) )
    ...
    in(view) connect ( o9r, in(view) notes "Flow Relationship" doubleWidth() place(directions.Right, o9r) )
    ...
    in(view) connect ( oAr, in(view) notes "Specialization Relationship" doubleWidth() place(directions.Right, oAr) )
    ...
    in(view) connect ( oBr, in(view) notes "Association Relationship" doubleWidth() place(directions.Right, oBr) )
